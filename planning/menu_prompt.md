...
- Listings for these routes should be similar to those of `src/routes/readme.mdx`
...
- Review these files in e2e/ for patterns involving readme
  - `navigation.spec.ts`
  - `readme.spec.ts`
- Develop a list of additions to navigate to and test `about`, `index`, `fullstack` and `jedi` to the same degree as readme
