  ...
  return (
    ...
    >
      ...
      <div class="col-start-1 row-start-1 py-24 px-10">
        ...
        <a
          class="inline-flex items-center justify-center px-4 min-h-13 font-semibold rounded-lg text-white transition-transform active:scale-95 bg-(--theme-btn-primary) hover:bg-(--theme-btn-primary-hover) shadow-md"
          href={local.ctaHref}
        >
          {local.ctaText}
        </a>
