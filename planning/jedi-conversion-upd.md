...
**Phase Complete**: Check-off phase, summarize + commit, prompt to clear context.
...
**Verification**: `vpr test:e2e` — all e2e tests pass.
...
**Phase Complete**: Check-off phase, summarize + commit, prompt to hand off to user for Phase 5.
