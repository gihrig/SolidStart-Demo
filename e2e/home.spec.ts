...
test.describe('Home Page', () => {
  test('should load successfully and display correct title', async ({
    page,
  }) => {
    await page.goto('/')
  ...
  test('should have working external link to solidjs.com in footer', async ({
    page,
  }) => {
    await page.goto('/')

    const solidjsLink = page
      .locator('footer')
      .getByRole('link', { name: /solidjs\.com/i })
  ...
  test('should have navigation link to About page in footer', async ({
    page,
  }) => {
    await page.goto('/')
  ...
  test('should navigate to About page when clicking footer link', async ({
    page,
  }) => {
    await page.goto('/')
